...
Не пиши бесполезных комментариев в коде, о том что что-то было изменено или о том, какой подход не был применён. Пояснения в большинстве случаев пиши просто в чате. Пиши комментарии только к неочевидным вещам.

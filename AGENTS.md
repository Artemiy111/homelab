...
Не пиши бесполезных комментариев в коде. То что требует внимания или пояснения пиши мне в чате. Когда работаешь с новой для репозитория технологией или вводишь новые параметры в конфиге которые не встречались, то поясняй что они делают.
